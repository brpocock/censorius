(asdf:defsystem :oliphaunt
  ...
  #-lispworks :mailto #-lispworks "brpocock+oliphaunt-lisp@star-hope.org"
  :licence "AGPLv3" ; if this poses a problem, ask me for a waiver.
  #-lispworks :long-name #-lispworks "Bruce-Robert Fenn Pocock's collection of various utility functions"
