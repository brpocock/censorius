...
return cljs.core.reduce.call(null,(function (result,p__20289){
var vec__20290 = p__20289;
var k = cljs.core.nth.call(null,vec__20290,(0),null);
var v = cljs.core.nth.call(null,vec__20290,(1),null);
...
var vec__20292 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__20292,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__20292,(1),null);
var ab = cljs.core.nth.call(null,vec__20292,(2),null);
...
clojure.data.EqualityPartition = (function (){var obj20294 = {};
return obj20294;
})();
...
return (function (){var or__3799__auto__ = (clojure.data.equality_partition[goog.typeOf(x__4443__auto__)]);
if(or__3799__auto__){
...
clojure.data.Diff = (function (){var obj20296 = {};
return obj20296;
})();

clojure.data.diff_similar = (function diff_similar(a,b){
if((function (){var and__3787__auto__ = a;
if(and__3787__auto__){
...
return (function (){var or__3799__auto__ = (clojure.data.diff_similar[goog.typeOf(x__4443__auto__)]);
if(or__3799__auto__){
return or__3799__auto__;
} else {
...
if((function (){var G__20297 = x;
if(G__20297){
var bit__4480__auto__ = (G__20297.cljs$lang$protocol_mask$partition0$ & (1024));
if((bit__4480__auto__) || (G__20297.cljs$core$IMap$)){
return true;
} else {
if((!G__20297.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMap,G__20297);
} else {
return false;
}
}
...
if((function (){var G__20298 = x;
if(G__20298){
var bit__4480__auto__ = (G__20298.cljs$lang$protocol_mask$partition0$ & (4096));
if((bit__4480__auto__) || (G__20298.cljs$core$ISet$)){
return true;
} else {
if((!G__20298.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISet,G__20298);
} else {
return false;
}
}
...
if((function (){var G__20299 = x;
if(G__20299){
var bit__4480__auto__ = (G__20299.cljs$lang$protocol_mask$partition0$ & (16777216));
if((bit__4480__auto__) || (G__20299.cljs$core$ISequential$)){
return true;
} else {
if((!G__20299.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISequential,G__20299);
} else {
return false;
}
}
...
return (function (){var G__20300 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__20300) {
case "map":
