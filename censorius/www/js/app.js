...
goog.addDependency("../censorius/editable.js", ['censorius.editable'], ['reagent.core', 'cljs.core', 'clojure.string']);
goog.addDependency("../censorius/data.js", ['censorius.data'], ['reagent.core', 'cljs.core', 'clojure.string']);
goog.addDependency("../censorius/guest.js", ['censorius.guest'], ['censorius.staff', 'reagent.session', 'censorius.text', 'reagent.core', 'cljs.core', 'goog.history.EventType', 'goog.History', 'cljs.core.async', 'censorius.radio', 'censorius.utils', 'secretary.core', 'censorius.editable', 'clojure.string', 'clojure.data', 'goog.events', 'censorius.data']);
goog.addDependency("../censorius/guest_list.js", ['censorius.guest_list'], ['censorius.text', 'reagent.core', 'cljs.core', 'censorius.utils', 'censorius.guest', 'clojure.string', 'censorius.data']);
goog.addDependency("../censorius/page.js", ['censorius.page'], ['reagent.session', 'censorius.text', 'reagent.core', 'cljs.core', 'goog.history.EventType', 'datascript', 'goog.History', 'censorius.utils', 'secretary.core', 'censorius.guest', 'clojure.string', 'goog.events', 'censorius.data', 'censorius.guest_list']);
