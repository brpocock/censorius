...
return (new datascript.query.Context(new cljs.core.Keyword(null,"rels","rels",1770187185).cljs$core$IFn$_invoke$arity$1(G__20724),new cljs.core.Keyword(null,"sources","sources",-321166424).cljs$core$IFn$_invoke$arity$1(G__20724),new cljs.core.Keyword(null,"rules","rules",1198912366).cljs$core$IFn$_invoke$arity$1(G__20724),null,cljs.core.dissoc.call(null,G__20724,new cljs.core.Keyword(null,"rels","rels",1770187185),new cljs.core.Keyword(null,"sources","sources",-321166424),new cljs.core.Keyword(null,"rules","rules",1198912366)),null));
});
...
while (G__20770__i < G__20770__a.length) {G__20770__a[G__20770__i] = arguments[G__20770__i + 2]; ++G__20770__i;}
...
if((function (){var G__20827 = source;
if(G__20827){
...
});})(tuples,temp__4124__auto__,tuple_fn,vec__20849,vec__20850,f,args,out,fun,vec__20851,context__$1,production))
,tuples));
} else {
...
});})(i__20869,vec__20875,vec__20876,_,rule_args,clauses,replacements,branch,c__4553__auto__,size__4554__auto__,b__20870,s__20868__$2,temp__4126__auto__,vec__20866,rule,call_args,seqid,branches))
,clauses));
...
});})(vec__20877,vec__20878,_,rule_args,clauses,replacements,branch,s__20868__$2,temp__4126__auto__,vec__20866,rule,call_args,seqid,branches))
,clauses),iter__20867.call(null,cljs.core.rest.call(null,s__20868__$2)));
}
} else {
return null;
}
...
});})(stack,rel,vec__20923,rule,call_args,guards,vec__20924,active_gs,pending_gs,vec__20921,clauses,vec__20922,rule_clause,next_clauses,frame,temp__4124__auto__,final_attrs,final_attrs_map,solve,empty_rels_QMARK_))
,active_gs))){
...
var G__20935 = cljs.core.concat.call(null,(function (){var iter__4555__auto__ = ((function (stack,rel,used_args,branches,prefix_clauses,prefix_context,vec__20923,rule,call_args,guards,vec__20924,active_gs,pending_gs,vec__20921,clauses,vec__20922,rule_clause,next_clauses,frame,temp__4124__auto__,final_attrs,final_attrs_map,solve,empty_rels_QMARK_){
...
var G__20962 = (function (){var iter__4555__auto__ = ((function (acc,rels,symbols,copy_map,len,keep_attrs,rel,temp__4124__auto__){
...
if((function (){var i__20957 = (0);
while(true){
if((i__20957 < size__4554__auto__)){
var t2 = cljs.core._nth.call(null,c__4553__auto__,i__20957);
cljs.core.chunk_append.call(null,b__20958,(function (){var res = cljs.core.aclone.call(null,t1);
...
});})(G__21010,q__$2,find,ins,wheres,context,resultset))
,G__21010):G__21010);
...
while (G__21011__i < G__21011__a.length) {G__21011__a[G__21011__i] = arguments[G__21011__i + 1]; ++G__21011__i;}
