...
weasel.repl.process_message = (function (){var method_table__4696__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
}catch (e21141){if((e21141 instanceof Error)){
var e = e21141;
...
repl_print.cljs$lang$applyTo = (function (arglist__21143){
var args = cljs.core.seq(arglist__21143);
...
while (G__21144__i < G__21144__a.length) {G__21144__a[G__21144__i] = arguments[G__21144__i + 0]; ++G__21144__i;}
  args = new cljs.core.IndexedSeq(G__21144__a,0);
} 
return console_print__delegate.call(this,args);};
console_print.cljs$lang$maxFixedArity = 0;
console_print.cljs$lang$applyTo = (function (arglist__21145){
...
while (G__21147__i < G__21147__a.length) {G__21147__a[G__21147__i] = arguments[G__21147__i + 0]; ++G__21147__i;}
  args = new cljs.core.IndexedSeq(G__21147__a,0);
} 
...
var connect__delegate = function (repl_server_url,p__21149){
var map__21152 = p__21149;
var map__21152__$1 = ((cljs.core.seq_QMARK_.call(null,map__21152))?cljs.core.apply.call(null,cljs.core.hash_map,map__21152):map__21152);
var print = cljs.core.get.call(null,map__21152__$1,new cljs.core.Keyword(null,"print","print",1299562414),new cljs.core.Keyword(null,"repl","repl",-35398667));
var on_close = cljs.core.get.call(null,map__21152__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var on_error = cljs.core.get.call(null,map__21152__$1,new cljs.core.Keyword(null,"on-error","on-error",1728533530));
var on_open = cljs.core.get.call(null,map__21152__$1,new cljs.core.Keyword(null,"on-open","on-open",-1391088163));
var verbose = cljs.core.get.call(null,map__21152__$1,new cljs.core.Keyword(null,"verbose","verbose",1694226060),true);
var repl_connection = weasel.impls.websocket.websocket_connection.call(null);
cljs.core.swap_BANG_.call(null,weasel.repl.ws_connection,cljs.core.constantly.call(null,repl_connection));

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (repl_connection,map__21152,map__21152__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
...
});})(repl_connection,map__21152,map__21152__$1,print,on_close,on_error,on_open,verbose))
);

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"message","message",-406056002),((function (repl_connection,map__21152,map__21152__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
var map__21153 = cljs.reader.read_string.call(null,evt.message);
var map__21153__$1 = ((cljs.core.seq_QMARK_.call(null,map__21153))?cljs.core.apply.call(null,cljs.core.hash_map,map__21153):map__21153);
var message = map__21153__$1;
var op = cljs.core.get.call(null,map__21153__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
var response = cljs.core.pr_str.call(null,weasel.repl.process_message.call(null,message));
return clojure.browser.net.transmit.call(null,repl_connection,response);
});})(repl_connection,map__21152,map__21152__$1,print,on_close,on_error,on_open,verbose))
);

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (repl_connection,map__21152,map__21152__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
...
clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"error","error",-978969032),((function (repl_connection,map__21152,map__21152__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
if(cljs.core.truth_(verbose)){
...
var G__21154__i = 0, G__21154__a = new Array(arguments.length -  1);
while (G__21154__i < G__21154__a.length) {G__21154__a[G__21154__i] = arguments[G__21154__i + 1]; ++G__21154__i;}
  p__21149 = new cljs.core.IndexedSeq(G__21154__a,0);
} 
return connect__delegate.call(this,repl_server_url,p__21149);};
connect.cljs$lang$maxFixedArity = 1;
connect.cljs$lang$applyTo = (function (arglist__21155){
var repl_server_url = cljs.core.first(arglist__21155);
var p__21149 = cljs.core.rest(arglist__21155);
return connect__delegate(repl_server_url,p__21149);
});
