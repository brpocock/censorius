...
if(!goog.isProvided_('censorius.guest')) {
...
goog.require('censorius.editable');
goog.require('censorius.data');
/**
* @param {...*} var_args
*/
censorius.guest.abbr_STAR_ = (function() { 
var abbr_STAR___delegate = function (short$,more){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),short$], null);
};
var abbr_STAR_ = function (short$,var_args){
var more = null;
if (arguments.length > 1) {
var G__11132__i = 0, G__11132__a = new Array(arguments.length -  1);
while (G__11132__i < G__11132__a.length) {G__11132__a[G__11132__i] = arguments[G__11132__i + 1]; ++G__11132__i;}
  more = new cljs.core.IndexedSeq(G__11132__a,0);
} 
return abbr_STAR___delegate.call(this,short$,more);};
abbr_STAR_.cljs$lang$maxFixedArity = 1;
abbr_STAR_.cljs$lang$applyTo = (function (arglist__11133){
var short$ = cljs.core.first(arglist__11133);
var more = cljs.core.rest(arglist__11133);
return abbr_STAR___delegate(short$,more);
});
abbr_STAR_.cljs$core$IFn$_invoke$arity$variadic = abbr_STAR___delegate;
return abbr_STAR_;
})()
;
censorius.guest.mmap = (function mmap(m,f,a){
...
var G__11135 = (((new cljs.core.Keyword(null,"gender","gender",-733930727).cljs$core$IFn$_invoke$arity$1(guest) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"gender","gender",-733930727).cljs$core$IFn$_invoke$arity$1(guest).fqn:null);
switch (G__11135) {
case "f":
return "\uD83D\uDC69";
...
return cljs.core.some.call(null,(function (p__11139){
...
censorius.guest.married_line = (function married_line(p__11141,children,self){
var map__11144 = p__11141;
var map__11144__$1 = ((cljs.core.seq_QMARK_.call(null,map__11144))?cljs.core.apply.call(null,cljs.core.hash_map,map__11144):map__11144);
var to = cljs.core.get.call(null,map__11144__$1,new cljs.core.Keyword(null,"to","to",192099007));
var from = cljs.core.get.call(null,map__11144__$1,new cljs.core.Keyword(null,"from","from",1815293044));
return new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),censorius.guest.couple_icon.call(null,from,to)," ",(function (){var G__11145 = (((new cljs.core.Keyword(null,"gender","gender",-733930727).cljs$core$IFn$_invoke$arity$1(from) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"gender","gender",-733930727).cljs$core$IFn$_invoke$arity$1(from).fqn:null);
switch (G__11145) {
case "f":
return "wife";
...
censorius.guest.marital_edit = (function marital_edit(p__11147,children,this$){
var map__11153 = p__11147;
...
var guest = cljs.core.get.call(null,map__11153__$1,new cljs.core.Keyword(null,"guest","guest",692663006));
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__11157),iter__11154.call(null,cljs.core.chunk_rest.call(null,s__11155__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__11157),null);
}
} else {
var bachelor = cljs.core.first.call(null,s__11155__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"checkbox",new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (bachelor,s__11155__$2,temp__4126__auto__,bachelors,spouse,map__11153,map__11153__$1,guest){
return (function (){
return censorius.guest.marry_BANG_.call(null,guest,bachelor);
});})(bachelor,s__11155__$2,temp__4126__auto__,bachelors,spouse,map__11153,map__11153__$1,guest))
,new cljs.core.Keyword(null,"name","name",1843675177),censorius.utils.gensymreally.call(null,[cljs.core.str(cljs.core.name),cljs.core.str("/marry")].join('')),new cljs.core.Keyword(null,"checked","checked",-50955819),false], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [censorius.guest.married_line,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"from","from",1815293044),guest,new cljs.core.Keyword(null,"to","to",192099007),bachelor], null)], null)], null),iter__11154.call(null,cljs.core.rest.call(null,s__11155__$2)));
}
} else {
return null;
}
...
censorius.guest.name_edit_box = (function name_edit_box(guest,children,this$){
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),cljs.core.conj.call(null,cljs.core.PersistentVector.EMPTY,children),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [censorius.text.text_input,new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),guest,new cljs.core.Keyword(null,"keys","keys",1068423698),new cljs.core.Keyword(null,"given-name","given-name",208174286),new cljs.core.Keyword(null,"label","label",1718410804),"Given name",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"John",new cljs.core.Keyword(null,"format","format",-1306924766),censorius.utils.name_case,new cljs.core.Keyword(null,"validate","validate",-201300827),censorius.utils.a_name_QMARK_,new cljs.core.Keyword(null,"rows","rows",850049680),(1)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [censorius.text.text_input,new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),guest,new cljs.core.Keyword(null,"keys","keys",1068423698),new cljs.core.Keyword(null,"surname","surname",1407918027),new cljs.core.Keyword(null,"label","label",1718410804),"Surname",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Doe",new cljs.core.Keyword(null,"format","format",-1306924766),censorius.utils.name_case,new cljs.core.Keyword(null,"validate","validate",-201300827),censorius.utils.a_name_QMARK_,new cljs.core.Keyword(null,"rows","rows",850049680),(1)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [censorius.text.text_input,new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),guest,new cljs.core.Keyword(null,"keys","keys",1068423698),new cljs.core.Keyword(null,"called-by","called-by",-644178399),new cljs.core.Keyword(null,"label","label",1718410804),"Called by",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Fuzzy Owl",new cljs.core.Keyword(null,"format","format",-1306924766),censorius.utils.name_case,new cljs.core.Keyword(null,"validate","validate",-201300827),censorius.utils.a_name_QMARK_,new cljs.core.Keyword(null,"rows","rows",850049680),(1)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [censorius.radio.radio_set,guest,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"label","label",1718410804),"Gender (optional)",new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"gender","gender",-733930727),new cljs.core.Keyword(null,"tags","tags",1771418977),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,"\u2295 (not given)"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"m","m",1632677161),"\u2642 Male"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"f","f",-1597136552),"\u2640 Female"], null)], null)], null)], null)], null);
});
...
censorius.guest.name_cell = (function name_cell(guest){
var editing = reagent.core.atom.call(null,false);
return ((function (editing){
return (function (guest__$1){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),censorius.editable.click_edit.call(null,editing,new cljs.core.Keyword(null,"name","name",1843675177)),(cljs.core.truth_(cljs.core.deref.call(null,editing))?new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [censorius.guest.name_edit_box,guest__$1], null),((((1) < cljs.core.count.call(null,cljs.core.deref.call(null,censorius.data.guests))))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),"false",new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (editing){
return (function (){
if(cljs.core.truth_(confirm([cljs.core.str("Remove "),cljs.core.str((function (){var or__3799__auto__ = new cljs.core.Keyword(null,"called-by","called-by",-644178399).cljs$core$IFn$_invoke$arity$1(guest__$1);
if(cljs.core.truth_(or__3799__auto__)){
return or__3799__auto__;
} else {
return new cljs.core.Keyword(null,"given","given",716253602).cljs$core$IFn$_invoke$arity$1(guest__$1);
}
})()),cljs.core.str(" from your party?")].join('')))){
return cljs.core.swap_BANG_.call(null,censorius.data.guests,censorius.guest.mmap,cljs.core.remove,((function (editing){
return (function (it){
return cljs.core._EQ_.call(null,cljs.core.deref.call(null,it),guest__$1);
});})(editing))
);
} else {
return null;
...
], null),"Remove from party"], null)], null):null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),"close true",new cljs.core.Keyword(null,"on-click","on-click",1632826543),cljs.core.reset_BANG_.call(null,editing,false)], null),"\u2713"], null)], null):null),censorius.guest.abbr_STAR_.call(null,(function (){var or__3799__auto__ = new cljs.core.Keyword(null,"called-by","called-by",-644178399).cljs$core$IFn$_invoke$arity$1(guest__$1);
if(cljs.core.truth_(or__3799__auto__)){
return or__3799__auto__;
} else {
return new cljs.core.Keyword(null,"given-name","given-name",208174286).cljs$core$IFn$_invoke$arity$1(guest__$1);
}
})(),[cljs.core.str(new cljs.core.Keyword(null,"given-name","given-name",208174286).cljs$core$IFn$_invoke$arity$1(guest__$1)),cljs.core.str(" "),cljs.core.str(new cljs.core.Keyword(null,"surname","surname",1407918027).cljs$core$IFn$_invoke$arity$1(guest__$1))].join(''))], null);
});
;})(editing))
});
censorius.guest.email_cell = (function email_cell(guest){
var editing = reagent.core.atom.call(null,false);
return ((function (editing){
return (function (guest__$1){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),censorius.editable.click_edit.call(null,editing,new cljs.core.Keyword(null,"mail","mail",795732905)),(cljs.core.truth_(cljs.core.deref.call(null,editing))?censorius.utils.modality.call(null,((function (editing){
return (function (){
return cljs.core.reset_BANG_.call(null,editing,false);
});})(editing))
,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"pop-out"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [censorius.text.text_input,new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),guest__$1,new cljs.core.Keyword(null,"keys","keys",1068423698),new cljs.core.Keyword(null,"e-mail","e-mail",270044236),new cljs.core.Keyword(null,"label","label",1718410804),"eMail address",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"jdoe@example.com",new cljs.core.Keyword(null,"format","format",-1306924766),censorius.utils.format_email,new cljs.core.Keyword(null,"validate","validate",-201300827),censorius.utils.email_QMARK_,new cljs.core.Keyword(null,"rows","rows",850049680),(1)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),"close true",new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (editing){
return (function (){
return cljs.core.reset_BANG_.call(null,editing,false);
});})(editing))
...
return censorius.guest.abbr_STAR_.call(null,"\u2709",mail);
} else {
return censorius.guest.abbr_STAR_.call(null,"\u20E0","No e-mail address");
}
})()], null);
});
;})(editing))
});
censorius.guest.phone_cell = (function phone_cell(guest){
var editing = reagent.core.atom.call(null,false);
return ((function (editing){
return (function (guest__$1){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),censorius.editable.click_edit.call(null,editing,new cljs.core.Keyword(null,"phone","phone",-763596057)),((cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"phone","phone",-763596057),cljs.core.deref.call(null,editing)))?new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"pop-out"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [censorius.text.text_input,new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),guest__$1,new cljs.core.Keyword(null,"keys","keys",1068423698),new cljs.core.Keyword(null,"telephone","telephone",1304285416),new cljs.core.Keyword(null,"label","label",1718410804),"Phone number",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"(305) 555-1234",new cljs.core.Keyword(null,"format","format",-1306924766),censorius.utils.format_phone,new cljs.core.Keyword(null,"validate","validate",-201300827),censorius.utils.phone_number_QMARK_,new cljs.core.Keyword(null,"rows","rows",850049680),(1)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),"close true",new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (editing){
return (function (){
return cljs.core.reset_BANG_.call(null,editing,false);
});})(editing))
...
return censorius.guest.abbr_STAR_.call(null,"\uD83D\uDCDE",phone);
} else {
return censorius.guest.abbr_STAR_.call(null,"\u20E0","No telephone number");
}
})()], null);
});
;})(editing))
});
censorius.guest.ticket_cell = (function ticket_cell(guest){
var editing = reagent.core.atom.call(null,false);
return ((function (editing){
return (function (guest__$1){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),censorius.editable.click_edit.call(null,editing,new cljs.core.Keyword(null,"ticket-type","ticket-type",-847802505)),(cljs.core.truth_(cljs.core.deref.call(null,editing))?(function (){
...
var tag_list_11161 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"adult","adult",-1130256462),"\uD83C\uDFAB Adult"], null)], null);
var tag_list_11162__$1 = (((new cljs.core.Keyword(null,"spouse","spouse",-750497167).cljs$core$IFn$_invoke$arity$1(guest__$1) == null))?cljs.core.conj.call(null,tag_list_11161,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"child","child",623967545),"\uD83C\uDFAB\uD83D\uDEB8 Child (ages 5\u219217)"], null)):tag_list_11161);
var tag_list_11163__$2 = ((cljs.core.not.call(null,new cljs.core.Keyword(null,"staff?","staff?",1233722098).cljs$core$IFn$_invoke$arity$1(guest__$1)))?cljs.core.conj.call(null,tag_list_11162__$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"baby","baby",-1305225347),"\uD83C\uDFAB\uD83D\uDEB6 Child (birth\u21924 years)"], null)):tag_list_11162__$1);
new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [censorius.radio.radio_set,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"label","label",1718410804),"Ticket type",new cljs.core.Keyword(null,"cursor","cursor",1011937484),guest__$1,new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"ticket-type","ticket-type",-847802505),new cljs.core.Keyword(null,"tags","tags",1771418977),tag_list_11163__$2], null)], null);
...
:null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),(function (){var G__11160 = (((new cljs.core.Keyword(null,"ticket-type","ticket-type",-847802505).cljs$core$IFn$_invoke$arity$1(guest__$1) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"ticket-type","ticket-type",-847802505).cljs$core$IFn$_invoke$arity$1(guest__$1).fqn:null);
switch (G__11160) {
case "baby":
return censorius.guest.abbr_STAR_.call(null,"\uD83C\uDFAB\uD83D\uDEB6","Baby","Children from birth to 4 years old");

break;
case "child":
return censorius.guest.abbr_STAR_.call(null,"\uD83C\uDFAB\uD83D\uDEB8","Child","Childrpn from ages 5 through 17");

break;
default:
return censorius.guest.abbr_STAR_.call(null,"\uD83C\uDFAB","Adult");

}
})()," ",(cljs.core.truth_(censorius.staff.lugal_PLUS__QMARK_.call(null,guest__$1))?censorius.guest.abbr_STAR_.call(null,"\uD808\uDE17","Lugal","Lugals head each department. This ticket type also includes Division Co\u00F6rdinators or members of the Board of Directors."):(cljs.core.truth_(censorius.guest.lugal_PLUS__spouse_QMARK_.call(null,guest__$1))?censorius.guest.abbr_STAR_.call(null,[cljs.core.str("\uD808\uDE17"),cljs.core.str(censorius.guest.couple_icon.call(null,guest__$1))].join(''),"Lugal spouse","Spouse of a lugal (or DC or board member)"):(cljs.core.truth_(new cljs.core.Keyword(null,"staff?","staff?",1233722098).cljs$core$IFn$_invoke$arity$1(guest__$1))?censorius.guest.abbr_STAR_.call(null,"\u26E4","Staff","General staff members (not a lugal)"):null)))], null)], null);
});
;})(editing))
});
censorius.guest.days_cell = (function days_cell(guest){
var editing = reagent.core.atom.call(null,false);
return ((function (editing){
return (function (guest__$1){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),censorius.editable.click_edit.call(null,editing,new cljs.core.Keyword(null,"days","days",-1394072564)),(cljs.core.truth_(cljs.core.deref.call(null,editing))?new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"pop-out"], null),(cljs.core.truth_(new cljs.core.Keyword(null,"staff?","staff?",1233722098).cljs$core$IFn$_invoke$arity$1(guest__$1))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),"Tuesday\u2192Sunday",new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"hint"], null),"Staff members are always a full week admission"], null)], null):new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [censorius.radio.radio_set,guest__$1,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"label","label",1718410804),"Days attending",new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"days","days",-1394072564),new cljs.core.Keyword(null,"tags","tags",1771418977),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,"Wednesday\u2192Sunday"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"week-end","week-end",-1868033285),"Friday\u2192Sunday"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"day","day",-274800446),"One day"], null)], null)], null)], null)),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),"close true",new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (editing){
return (function (){
return cljs.core.reset_BANG_.call(null,editing,false);
});})(editing))
], null),"\u2713"], null)], null):censorius.guest.abbr_STAR_.call(null,(function (){var G__11167 = new cljs.core.Keyword(null,"days","days",-1394072564).cljs$core$IFn$_invoke$arity$1(guest__$1);
if(cljs.core._EQ_.call(null,null,G__11167)){
...
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"week-end","week-end",-1868033285),G__11167)){
return "Fri-Sun";
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"day","day",-274800446),G__11167)){
return "Day";
} else {
...
})(),(function (){var G__11168 = new cljs.core.Keyword(null,"days","days",-1394072564).cljs$core$IFn$_invoke$arity$1(guest__$1);
if(cljs.core._EQ_.call(null,null,G__11168)){
...
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"week-end","week-end",-1868033285),G__11168)){
return "Week-end only, Friday\u2192Sunday";
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"day","day",-274800446),G__11168)){
return "Any one day";
} else {
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(new cljs.core.Keyword(null,"days","days",-1394072564).cljs$core$IFn$_invoke$arity$1(guest__$1))].join('')));
