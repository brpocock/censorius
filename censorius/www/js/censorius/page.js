...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"thead","thead",-291875296),new cljs.core.PersistentVector(null, 11, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),censorius.page.abbr.call(null,"Name","Names of each party member.")], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),censorius.page.abbr.call(null,"\u2709","eMail")], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),censorius.page.abbr.call(null,"\uD83D\uDCDE","Phone#")], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),censorius.page.abbr.call(null,"\uD83D\uDEB8","Ticket")], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),censorius.page.abbr.call(null,"\uD83D\uDCC5","Days")], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),censorius.page.abbr.call(null,"\u26FA/\uD83C\uDFE0","Sleeping")], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),censorius.page.abbr.call(null,"\uD83C\uDF72\uD83C\uDF74","Meals")], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),censorius.page.abbr.call(null,"\uD83D\uDC55","T-Shirt")], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),censorius.page.abbr.call(null,"\uD83D\uDCBC","Tote")], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),censorius.page.abbr.call(null,"\uD83C\uDF7A","Mug")], null)], null)], null);
});
censorius.page.guest_price = (function guest_price(guest){
return ((((((cljs.core.truth_(new cljs.core.Keyword(null,"lugal+?","lugal+?",1775456646).cljs$core$IFn$_invoke$arity$1(guest))?(0):(cljs.core.truth_(new cljs.core.Keyword(null,"staff?","staff?",1233722098).cljs$core$IFn$_invoke$arity$1(guest))?(300):(cljs.core.truth_(new cljs.core.Keyword(null,"adult?","adult?",-133070051).cljs$core$IFn$_invoke$arity$1(guest))?(function (){var G__10311 = new cljs.core.Keyword(null,"days","days",-1394072564).cljs$core$IFn$_invoke$arity$1(guest);
...
))) + (function (){var G__10312 = (((new cljs.core.Keyword(null,"sleep","sleep",-1932665860).cljs$core$IFn$_invoke$arity$1(guest) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"sleep","sleep",-1932665860).cljs$core$IFn$_invoke$arity$1(guest).fqn:null);
switch (G__10312) {
case "lodge":
return (2000);
...
})()) + (function (){var G__10313 = (((new cljs.core.Keyword(null,"eat","eat",1686757401).cljs$core$IFn$_invoke$arity$1(guest) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"eat","eat",1686757401).cljs$core$IFn$_invoke$arity$1(guest).fqn:null);
switch (G__10313) {
case "cauldron":
return (7000);
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"card"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h2","h2",-372662728),"Ready to check out?"], null),new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"buttonBox"], null)," Total: ","$399.97"," ",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),"Pay Now"], null)], null)], null);
});
