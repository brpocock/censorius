...
(defn address [cursor address {:keys [korks label note]}]
                    ...
                    [:fieldset {:class "address-edit"}
                     [:legend nil
                      ...
                      [:span {:class (str "marker valid-" validity)}
                       validity-sigil]]
                     [:div [text/text-input address {:korks :address1
                                                     :label "Street address (line 1)"
                                                     :rows 0
                                                     :formatter util/name-case
                                                     :placeholder "123 Main St."}]]
                     [:div [text/text-input address {:korks :address2
                                                     :label "Street address (line 2)"
                                                     :rows 0
                                                     :formatter util/name-case
                                                     :placeholder "Ste. 123"}]]
                     [:div [text/text-input address {:korks :city
                                                     :label "City"
                                                     :rows 0
                                                     :formatter util/name-case
                                                     :placeholder "Nicetown"}]
                      ", "
                      [text/text-input address {:korks :state
                                                :label "State"
                                                :rows 0
                                                :formatter string/upper-case
                                                :placeholder "FL"}]
                      "   "
                      [text/text-input address {:korks :zip
                                                :label "ZIP code"
                                                :rows 0
